...
osg::Geode* createPyramid()
{
   ...
   colors->push_back(osg::Vec4(0.0f, 0.0f, 0.5f, 1.0f) ); //index 0 red
   colors->push_back(osg::Vec4(0.0f, 1.0f, 0.0f, 1.0f) ); //index 1 green
   colors->push_back(osg::Vec4(1.0f, 1.0f, 1.0f, 1.0f) ); //index 2 blue
   colors->push_back(osg::Vec4(1.0f, 0.60f, 0.0f, 1.0f) ); //index 3 white
   ...
   colorIndexArray->push_back(4); // vertex 4 assigned color array element 0
   ...
   (*texcoords)[1].set(0.66f,0.0f);
   (*texcoords)[2].set(0.33f,0.0f);
   (*texcoords)[3].set(0.0f,0.0f);
   (*texcoords)[4].set(0.0f,1.0f); 
